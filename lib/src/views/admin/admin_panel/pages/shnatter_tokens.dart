...
class AdminShnatterTokens extends StatefulWidget {
  AdminShnatterTokens({super.key});

  @override
  State createState() => AdminShnatterTokensState();
}

class AdminShnatterTokensState extends mvc.StateMVC<AdminShnatterTokens> {
  @override
  void initState() {
    super.initState();
  }
