                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Padding(padding: EdgeInsets.only(top: groupSubRoute == 'going' ? 26 : 0)),
                                                      RichText(
                                                      text: TextSpan(children: <TextSpan>[
                                                        TextSpan(
                                                          text: 'Going',
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Padding(padding: EdgeInsets.only(top: groupSubRoute == 'interested' ? 26 : 0)),
                                                      RichText(
                                                      text: TextSpan(children: <TextSpan>[
                                                        TextSpan(
                                                          text: 'Interested',
                                                          ...
                                                          recognizer: TapGestureRecognizer()
                                                            ..onTap = () {
                                                              groupSubRoute = 'interested';
                                                              setState(() { });
                                                            }
                                                          ),
                                                        ]),
                                                      ),
                                                      groupSubRoute == 'interested' ? Container(
                                                        margin: EdgeInsets.only(top: 26),
                                                        height: 1,
                                                        color: Colors.black,
                                                      ) : SizedBox()
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Padding(padding: EdgeInsets.only(top: groupSubRoute == 'invited' ? 26 : 0)),
                                                      RichText(
                                                      text: TextSpan(children: <TextSpan>[
                                                        TextSpan(
                                                          text: 'Invited',
                                                          ...
                                                          recognizer: TapGestureRecognizer()
                                                            ..onTap = () {
                                                              groupSubRoute = 'invited';
                                                              setState(() { });
                                                            }
                                                          ),
                                                        ]),
                                                      ),
                                                      groupSubRoute == 'invited' ? Container(
                                                        margin: EdgeInsets.only(top: 26),
                                                        height: 1,
                                                        color: Colors.black,
                                                      ) : SizedBox()
