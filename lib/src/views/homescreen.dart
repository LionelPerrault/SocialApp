...
class HomeScreenState extends mvc.StateMVC<HomeScreen> {
  ...
  TextEditingController emailController =
      TextEditingController(text: 'borismuslin.bm@gmail.com');
  TextEditingController passwordController =
      TextEditingController(text: 'wjdwkdwns');

  TextEditingController payMailController =
      TextEditingController(text: '4064@relysia.com');
          ...
          if (value == false)
            {
              showDialog(
                context: context,
                builder: (BuildContext context) => addEmail(context),
              )
            }
          else
    ...
    con.emailAlreadyExists
        ? Future.delayed(
            ...
            () => {
              ...
              showDialog(
                context: context,
                builder: (BuildContext context) => askPassword(context),
              )
            },
          )
        : null;
                ...
                Row(
                  children: [
                    MyPrimaryButton(
                      color: Colors.green,
                      buttonName: "English",
                      onPressed: () => {con.changeLaguage("en")},
                    ...
                    MyPrimaryButton(
                      color: Colors.green,
                      buttonName: "French",
                      onPressed: () => {con.changeLaguage("fr")},
                      miniumSize: const Size(60, 30),
                    ),
                  ],
                ),
                      ...
                      child: Padding(
                          ...
                          child: Column(
                            children: const [
                              SizedBox(
                                child:
                                    Image(image: AssetImage(Helper.tokenIcon)),
                                width: 20,
                                height: 20,
                              ),
                    ...
                    children: <Widget>[
                      Flexible(
                          ...
                          child: MyPrimaryButton(
                              ...
                              buttonName:
                                  con.isSendingToken ? "Sending..." : "Pay",
                              onPressed: () => {
                      ...
                      Flexible(
                          ...
                          child: MyPrimaryButton(
                              ...
                              onPressed: () async => {
                                    print("scan now ......"),
                                    if (rR = await Navigator.of(context)
                                            .pushNamed(RouteNames.qrCodeScan)
                                        is String)
                                      {
                                      ...
                                      {
                                        con.qrCode =
                                            "payto:4064@relysia.com?purpose=cashback&amount=1",
                                        if (con.processQrCode())
                                          con.payNow(context, false),
                                      }
                                  }))
...
>>>>>>> 83f8f0a66b581c6cda72c5b2dfb14bae49a84bc9
}
