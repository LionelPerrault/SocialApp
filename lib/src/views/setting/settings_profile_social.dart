...
class SettingsProfileSocial extends StatefulWidget {
  SettingsProfileSocial({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsProfileSocialState();
}

class SettingsProfileSocialState extends mvc.StateMVC<SettingsProfileSocial>
