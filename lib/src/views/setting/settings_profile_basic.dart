...
class SettingsProfileBasic extends StatefulWidget {
  SettingsProfileBasic({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsProfileBasicState();
}

class SettingsProfileBasicState extends mvc.StateMVC<SettingsProfileBasic>
