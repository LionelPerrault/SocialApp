...
class SettingsProfileDesign extends StatefulWidget {
  SettingsProfileDesign({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsProfileDesignState();
}

class SettingsProfileDesignState extends mvc.StateMVC<SettingsProfileDesign>
