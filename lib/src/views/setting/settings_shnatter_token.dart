...
class SettingsShnatterToken extends StatefulWidget {
  SettingsShnatterToken({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsShnatterTokenState();
}

class SettingsShnatterTokenState extends mvc.StateMVC<SettingsShnatterToken>
