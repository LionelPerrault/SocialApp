...
class SettingsProfileWork extends StatefulWidget {
  SettingsProfileWork({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsProfileWorkState();
}

class SettingsProfileWorkState extends mvc.StateMVC<SettingsProfileWork>
