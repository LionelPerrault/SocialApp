...
class SettingsInformation extends StatefulWidget {
  SettingsInformation({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsInformationState();
}

class SettingsInformationState extends mvc.StateMVC<SettingsInformation>
