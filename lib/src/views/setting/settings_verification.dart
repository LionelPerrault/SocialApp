...
class SettingsVerification extends StatefulWidget {
  SettingsVerification({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsVerificationState();
}

class SettingsVerificationState extends mvc.StateMVC<SettingsVerification>
