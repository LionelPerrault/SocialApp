...
class SettingsDelete extends StatefulWidget {
  SettingsDelete({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsDeleteState();
}

class SettingsDeleteState extends mvc.StateMVC<SettingsDelete>
