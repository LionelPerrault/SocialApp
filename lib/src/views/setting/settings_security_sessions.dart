...
class SettingsSecuritySessions extends StatefulWidget {
  SettingsSecuritySessions({Key? key})
      : con = HomeController(),
        super(key: key);
  final HomeController con;

  @override
  State createState() => SettingsSecuritySessionsState();
}

class SettingsSecuritySessionsState extends mvc
    .StateMVC<SettingsSecuritySessions> with SingleTickerProviderStateMixin {
